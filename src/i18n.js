...
const dictionaries = {
  zh: {
    ...
    'form.sortOrderLabel': '排序数字（可选）',
    'form.sortOrderPlaceholder': '数字越大越靠前，留空按更新时间排序',
    ...
    'table.actions': '操作',
    'table.sortOrder': '排序数字',
    'table.noSortOrder': '按时间排序',
    'table.open': '打开',
    'table.edit': '编辑',
    'table.delete': '删除',
    'table.disable': '停用',
  ...
  en: {
    ...
    'form.sortOrderLabel': 'Sort number (optional)',
    'form.sortOrderPlaceholder': 'Higher shows first; leave empty to sort by update time',
