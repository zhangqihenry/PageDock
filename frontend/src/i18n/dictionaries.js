...
const dictionaries = {
  zh: {
    ...
    'catalog.tabsLabel': '网页分类',
    'catalog.regular': '常规',
    'catalog.protected': '加密',
    'catalog.emptyRegular': '常规网页将显示在这里。',
    'catalog.emptyProtected': '设置了访问密码的网页将显示在这里。',
    'unlock.heading': '输入密码访问网页',
    'unlock.hint': '此网页已加密，请输入访问密码。',
    'unlock.submit': '解锁并访问',
    'unlock.submitting': '正在验证…',
    ...
    'form.pathLabel': '自定义访问路径（可选）',
    'form.pathPlaceholder': '例如 sample，或留空自动生成',
    'form.pathHint': '留空将自动生成 6 位数字和小写字母组成的随机路径。',
    'form.protectionLegend': '访问权限',
    'form.passwordProtected': '加密访问',
    'form.sitePassword': '访问密码',
    'form.passwordHint': '至少 6 个字符，可使用任意字符。',
    'form.keepPassword': '留空保留原密码；新密码至少 6 个字符。',
    'form.overwriteKeepsProtection': '覆盖已加密的网页时，不勾选将保留原密码；如需取消加密，请在网页列表中编辑。',
    ...
    'errorCode.INVALID_PASSWORD_PROTECTION': '密码保护选项无效。',
    'errorCode.SITE_PASSWORD_TOO_SHORT': '访问密码至少需要 6 个字符。',
    'errorCode.INVALID_SITE_PASSWORD': '访问密码错误，请重试。',
    'errorCode.SITE_PASSWORD_REQUIRED': '请输入访问密码。',
    'errorCode.PATH_GENERATION_FAILED': '暂时无法生成访问路径，请重试。',
    'errorCode.RATE_LIMITED': '登录尝试次数过多，请稍后再试。',
    'errorCode.UNLOCK_RATE_LIMITED': '密码尝试次数过多，请稍后再试。',
  ...
  en: {
    ...
    'catalog.tabsLabel': 'Page categories',
    'catalog.regular': 'Regular',
    'catalog.protected': 'Protected',
    'catalog.emptyRegular': 'Regular pages will appear here.',
    'catalog.emptyProtected': 'Password-protected pages will appear here.',
    'unlock.heading': 'Enter the page password',
    'unlock.hint': 'This page is protected. Enter its password to continue.',
    'unlock.submit': 'Unlock and open',
    ...
    'form.pathLabel': 'Custom path (optional)',
    'form.pathPlaceholder': 'e.g. sample, or leave blank',
    'form.pathHint': 'Leave blank for a random 6-character path using digits and lowercase letters.',
    'form.protectionLegend': 'Access',
    'form.passwordProtected': 'Password-protected access',
    'form.sitePassword': 'Page password',
    'form.passwordHint': 'At least 6 characters. Any characters are allowed.',
    'form.keepPassword': 'Leave blank to keep the password; a new password needs at least 6 characters.',
    'form.overwriteKeepsProtection': 'When replacing a protected page, leaving this unchecked keeps its password. To remove protection, edit the page in the list.',
    ...
    'errorCode.INVALID_PASSWORD_PROTECTION': 'Invalid password protection option.',
    'errorCode.SITE_PASSWORD_TOO_SHORT': 'The page password must be at least 6 characters.',
    'errorCode.INVALID_SITE_PASSWORD': 'Incorrect page password. Please try again.',
    'errorCode.SITE_PASSWORD_REQUIRED': 'Enter the page password.',
    'errorCode.PATH_GENERATION_FAILED': 'Unable to generate a path. Please try again.',
    'errorCode.RATE_LIMITED': 'Too many login attempts. Please try again later.',
    'errorCode.UNLOCK_RATE_LIMITED': 'Too many password attempts. Please try again later.',
